...
BEGIN_MESSAGE_MAP(Csmc-psipApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Csmc-psipApp construction

Csmc-psipApp::Csmc-psipApp()
{
...
// The one and only Csmc-psipApp object

Csmc-psipApp theApp;

// Csmc-psipApp initialization
...
BOOL Csmc-psipApp::InitInstance()
{
