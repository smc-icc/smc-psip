...
struct AccountSettings {
	...
	int callsColumnNumberWidth;
	int callsColumnNameWidth;
	int callsColumnPasswdWidth;
	int callsColumnUrlWidth;
	int callsColumnPortWidth;
	int callsColumnCalledWidth;
	int callsColumnDurationWidth;
	int callsColumnRegTimeoutWidth;
	int callsColumnStatusWidth;
	int callsColumnRTCPWidth;
