...
void AccountSettings::Init()
{
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnNumberWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnNumberWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnPasswdWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnNameWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callUrlCouomnWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnPasswdWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnUrlWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnUrlWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnPortWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnPortWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnCalledWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnCalledWidth = _wtoi(str);
													ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnDurationWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnDurationWidth = _wtoi(str);		
	
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnRegTimeoutWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnRegTimeoutWidth = _wtoi(str);

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnStatusWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnStatusWidth = _wtoi(str); 

	ptr = str.GetBuffer(255);
	GetPrivateProfileString(section, _T("callsColumnRTCPWidth"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	callsColumnRTCPWidth = _wtoi(str);
	/*							 
	ptr = str.GetBuffer(255);
...
void AccountSettings::SettingsSave()
{
	...
	str.Format(_T("%d"), callsColumnNumberWidth);
	WritePrivateProfileString(section, _T("callsColumnNumberWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnNameWidth);
	WritePrivateProfileString(section, _T("callsColumnNameWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnPasswdWidth);
	WritePrivateProfileString(section, _T("callsColumnPasswdWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnUrlWidth);
	WritePrivateProfileString(section, _T("callsColumnUrlWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnPortWidth);
	WritePrivateProfileString(section, _T("callsColumnPortWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnCalledWidth);
	WritePrivateProfileString(section, _T("callsColumnCalledWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnDurationWidth);
	WritePrivateProfileString(section, _T("callsColumnDurationWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnRegTimeoutWidth);
	WritePrivateProfileString(section, _T("callsColumnRegTimeoutWidth"), str, iniFile);

	str.Format(_T("%d"), callsColumnStatusWidth);
	WritePrivateProfileString(section, _T("callsColumnStatusWidth"), str, iniFile);


	str.Format(_T("%d"), callsColumnRTCPWidth);
	WritePrivateProfileString(section, _T("callsColumnRTCPWidth"), str, iniFile);
