...
enum EUserWndMessages
{
	...
	UM_DBLCLICKTAB,
	UM_QUERYTAB,
	UM_SET_MULTIPLE_REGISTER_STATE,
	UM_SET_MULTIPLE_CALL_STATE,
	UM_MULTIPLE_INCOMING_CALL,
...
typedef  std::map<CString,Call>		CallsMap;
typedef	 CallsMap::iterator			CallsMapIt;
...
struct call_user_data
{
	...
	CString commands;
	bool inConference;
	call_user_data(pjsua_call_id call_id)
		:tonegen_data(NULL)
		,inConference(false)
...
bool msip_call_send_dtmf_info(pjsua_call_id current_call, pj_str_t digits);
